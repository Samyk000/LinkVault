      ...
      >
        <div className="flex items-center gap-1.5 sm:gap-2 p-1 sm:p-1.5 md:p-2">
          ...
          <div className="flex items-center gap-0.5 flex-shrink-0">
            ...
            <div className={`hidden md:flex flex-shrink-0 transition-all duration-300 ${link.isFavorite ? 'opacity-100' : 'opacity-0 group-hover:opacity-100'
              }`}>
              <Button
                variant="ghost"
                size="icon"
              ...
              >
                <Star
                  className={`h-2 w-2 transition-all duration-200 ${link.isFavorite ? 'fill-yellow-400 text-yellow-400' : 'text-muted-foreground hover:text-yellow-400'
                    }`}
                />
              </Button>
            </div>
