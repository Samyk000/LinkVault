...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ref={ref}
    className={cn(
      "inline-flex h-5 shrink-0 items-center justify-center rounded border bg-transparent px-1.5 text-[10px] font-medium transition-colors hover:bg-secondary focus:outline-none focus:ring-1 focus:ring-ring disabled:pointer-events-none disabled:opacity-50",
      themeCn(
        "group-[.destructive]:border-black group-[.destructive]:bg-black group-[.destructive]:text-white group-[.destructive]:hover:bg-black/80 group-[.destructive]:focus:ring-black",
        "dark:group-[.destructive]:border-white dark:group-[.destructive]:bg-white dark:group-[.destructive]:text-black dark:group-[.destructive]:hover:bg-white/80 dark:group-[.destructive]:focus:ring-white"
      ),
      className
    )}
    {...props}
